...
class OpExchangeTypeTest extends AnyFunSuite {
  ...
  test("run EX DE,HL") {
    ...
    assert(sysTest.get.registerController.get(Regs.DE) == 0x0304)
    assert(sysTest.get.registerController.get(Regs.HL) == 0x0102)
  }
  ...
  test("run EX AF,AF1") {
    ...
    //then
    assert(sysTest.get.registerController.get(Regs.PC) == 1)
    assert(sysTest.get.registerController.get(Regs.AF) == 0x0304)
    assert(sysTest.get.registerController.get(Regs.AF1) == 0x0102)
  }
  ...
  test("run EXX") {
    ...
    //then
    assert(sysTest.get.registerController.get(Regs.PC) == 1)
    assert(sysTest.get.registerController.get(Regs.AF) == 0xF1F2)
    assert(sysTest.get.registerController.get(Regs.AF1) == 0xA1A2)
    assert(sysTest.get.registerController.get(Regs.BC) == 0xA3A4)
    assert(sysTest.get.registerController.get(Regs.BC1) == 0xF3F4)
    assert(sysTest.get.registerController.get(Regs.DE) == 0xA5A6)
    assert(sysTest.get.registerController.get(Regs.DE1) == 0xF5F6)
    assert(sysTest.get.registerController.get(Regs.HL) == 0xA7A8)
    assert(sysTest.get.registerController.get(Regs.HL1) == 0xF7F8)
  }
  ...
  test("run EX (SP),HL") {
    ...
    //then
    assert(sysTest.get.registerController.get(Regs.PC) == 1)
    assert(sysTest.get.registerController.get(Regs.HL) == 0xF2F1)
  ...
  test("run EX (SP),IX") {
    ...
    assert(sysTest.get.registerController.get(Regs.IX) == 0xE2E1)
    assert(sysTest.get.registerController.get(Regs.SP) == 0x0103)
  ...
  test("run EX (SP),IY") {
    ...
    //then
    assert(sysTest.get.registerController.get(Regs.PC) == 2)
    assert(sysTest.get.registerController.get(Regs.IY) == 0xE2E1)
    assert(sysTest.get.registerController.get(Regs.SP) == 0x0103)
    assert(sysTest.get.memoryController.get(0x0103)==0xB2)
    assert(sysTest.get.memoryController.get(0x0104)==0xB1)
  }
