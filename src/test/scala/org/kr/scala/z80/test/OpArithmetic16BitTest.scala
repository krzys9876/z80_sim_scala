...
class OpArithmetic16BitTest extends AnyFunSuite{
  ...
  test("run ADC qq,ss") {
    ...
    testArithReg(List(("F", 0xFF), ("HL", 0x0FFE),("DE", 0x0001)), List((0x0000, 0xED),(0x0001, 0x5A)), "HL",0x1000, "00_1_000",2)
  ...
  test("run SBC qq,ss") {
    ...
    testArithReg(List(("F", 0xFF), ("HL", 0x1001),("DE", 0x0001)), List((0x0000, 0xED),(0x0001, 0x52)), "HL",0x0FFF, "00_1_010",2)
