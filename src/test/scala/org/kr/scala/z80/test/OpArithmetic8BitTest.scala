...
class OpArithmetic8BitTest extends AnyFunSuite {
  ...
  test("run SBC A,r/(HL)/(IX+d)/(IY+d)/n") {
    // based on "real" Z80 emulator
    testArith(List(("F",0x00),("A",0x1D),("B",0x3F)),List((0x0000,0x98)),0xDE,"10_1_011")
    testArith(List(("F",0x01),("A",0xDE),("HL",0x0123)),List((0x0000,0x9E),(0x0123,0x3F)),0x9E,"10_1_010")
    testArith(List(("F",0x01),("A",0xDE),("IX",0x1111)),List((0x0000,0xDD),(0x0001,0x9E),(0x0002,0x01),(0x1112,0x3F)),0x9E,"10_1_010",3)
    testArith(List(("F",0x01),("A",0xDE),("IY",0x1111)),List((0x0000,0xFD),(0x0001,0x9E),(0x0002,0x02),(0x1113,0x3F)),0x9E,"10_1_010",3)

    testArith(List(("F",0x00),("A",0x00)),List((0x0000,0xDE),(0x0001,0x40)),0xC0,"10_0_011",2)
    testArith(List(("F",0x01),("A",0x20)),List((0x0000,0x9F)),0xFF,"10_1_011")
    testArith(List(("F",0x01),("A",0x51),("B",0x4A)),List((0x0000,0x98)),0x06,"00_1_010")
    testArith(List(("F",0x01),("A",0x52),("C",0x4A)),List((0x0000,0x99)),0x07,"00_1_010")
    testArith(List(("F",0x01),("A",0x53),("D",0x4A)),List((0x0000,0x9A)),0x08,"00_1_010")
    testArith(List(("F",0x01),("A",0x54),("E",0x40)),List((0x0000,0x9B)),0x13,"00_0_010")
    testArith(List(("F",0x01),("A",0x55),("H",0x40)),List((0x0000,0x9C)),0x14,"00_0_010")
    testArith(List(("F",0x01),("A",0x56),("L",0x40)),List((0x0000,0x9D)),0x15,"00_0_010")
  }
}
