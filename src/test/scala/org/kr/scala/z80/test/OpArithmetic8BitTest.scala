...
class OpArithmetic8BitTest extends AnyFunSuite {
  ...
  test("run AND r/(HL)/(IX+d)/(IY+d)/n") {
    // based on "real" Z80 emulator
    testArith(List(("A",0x00)),List((0x0000,0xA7)),0x00,"01_1_100")
    testArith(List(("A",0xFE)),List((0x0000,0xA7)),0xFE,"10_1_000")
    testArith(List(("A",0xEF),("B",0xFE)),List((0x0000,0xA0)),0xEE,"10_1_100")
    testArith(List(("A",0xEC),("C",0x04)),List((0x0000,0xA1)),0x04,"00_1_000")
    testArith(List(("A",0xF0),("D",0xA2)),List((0x0000,0xA2)),0xA0,"10_1_100")
    testArith(List(("A",0xF0),("E",0xA2)),List((0x0000,0xA3)),0xA0,"10_1_100")
    testArith(List(("A",0xF0),("H",0xA2)),List((0x0000,0xA4)),0xA0,"10_1_100")
    testArith(List(("A",0xF0),("L",0xA2)),List((0x0000,0xA5)),0xA0,"10_1_100")
    testArith(List(("A",0xF0),("HL",0x1010)),List((0x0000,0xA6),(0x1010,0xA2)),0xA0,"10_1_100")
    testArith(List(("A",0xF0),("IX",0x2020)),List((0x0000,0xDD),(0x0001,0xA6),(0x0002,0x10),(0x2030,0xA2)),0xA0,"10_1_100",3)
    testArith(List(("A",0xF0),("IY",0x2020)),List((0x0000,0xFD),(0x0001,0xA6),(0x0002,0xF0),(0x2010,0xA2)),0xA0,"10_1_100",3)
    testArith(List(("A",0xF0)),List((0x0000,0xE6),(0x0001,0xA2)),0xA0,"10_1_100",2)
  }

  test("run XOR r/(HL)/(IX+d)/(IY+d)/n") {
    // based on "real" Z80 emulator
    testArith(List(("A",0x11)),List((0x0000,0xAF)),0x00,"01_0_100")
    testArith(List(("A",0xEF),("B",0xFE)),List((0x0000,0xA8)),0x11,"00_0_100")
    testArith(List(("A",0xEF),("C",0xFF)),List((0x0000,0xA9)),0x10,"00_0_000")
    testArith(List(("A",0xFF),("D",0x00)),List((0x0000,0xAA)),0xFF,"10_0_100")
    testArith(List(("A",0xFC),("E",0xFF)),List((0x0000,0xAB)),0x03,"00_0_100")
    testArith(List(("A",0xF0),("H",0xCE)),List((0x0000,0xAC)),0x3E,"00_0_000")
    testArith(List(("A",0xF0),("L",0xCE)),List((0x0000,0xAD)),0x3E,"00_0_000")
    testArith(List(("A",0xF0),("HL",0x1011)),List((0x0000,0xAE),(0x1011,0xCE)),0x3E,"00_0_000")
    testArith(List(("A",0xF0),("IX",0x2120)),List((0x0000,0xDD),(0x0001,0xAE),(0x0002,0x10),(0x2130,0xCE)),0x3E,"00_0_000",3)
    testArith(List(("A",0xF0),("IY",0x2120)),List((0x0000,0xFD),(0x0001,0xAE),(0x0002,0xF0),(0x2110,0xCE)),0x3E,"00_0_000",3)
    testArith(List(("A",0xF0)),List((0x0000,0xEE),(0x0001,0xCE)),0x3E,"00_0_000",2)
  }

  test("run OR r/(HL)/(IX+d)/(IY+d)/n") {
    // based on "real" Z80 emulator
    testArith(List(("A",0x00)),List((0x0000,0xB7)),0x00,"01_0_100")
    testArith(List(("A",0xAB)),List((0x0000,0xB7)),0xAB,"10_0_000")
    testArith(List(("A",0x30),("B",0x02)),List((0x0000,0xB0)),0x32,"00_0_000")
    testArith(List(("A",0x40),("C",0x03)),List((0x0000,0xB1)),0x43,"00_0_000")
    testArith(List(("A",0x50),("D",0x04)),List((0x0000,0xB2)),0x54,"00_0_000")
    testArith(List(("A",0x60),("E",0x05)),List((0x0000,0xB3)),0x65,"00_0_100")
    testArith(List(("A",0x70),("H",0x06)),List((0x0000,0xB4)),0x76,"00_0_000")
    testArith(List(("A",0x80),("L",0x07)),List((0x0000,0xB5)),0x87,"10_0_100")
    testArith(List(("A",0x80),("HL",0x1010)),List((0x0000,0xB6),(0x1010,0x07)),0x87,"10_0_100")
    testArith(List(("A",0x80),("IX",0x1020)),List((0x0000,0xDD),(0x0001,0xB6),(0x0002,0x10),(0x1030,0x07)),0x87,"10_0_100",3)
