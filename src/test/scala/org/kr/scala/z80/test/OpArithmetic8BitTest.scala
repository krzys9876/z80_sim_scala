...
class OpArithmetic8BitTest extends AnyFunSuite {
  ...
  test("run ADD A,r") {
    ...
    testAddR(0x81,"C",0x63,0x3E,0xA1,"10_1_100")
    testAddR(0x82,"D",0xA1,0x3E,0xDF,"10_0_000")
    testAddR(0x83,"E",0xDF,0x3E,0x1D,"00_1_001")

    testAddR(0x84,"H",0x00,0x40,0x40,"00_0_000")
    testAddR(0x85,"L",0x40,0x40,0x80,"10_0_100")
    testAddR(0x80,"B",0x80,0x40,0xC0,"10_0_000")
    testAddR(0x81,"C",0xC0,0x40,0x00,"01_0_001")

    testAddR(0x82,"D",0x20,0xF0,0x10,"00_0_001")
    testAddR(0x83,"E",0x10,0xF0,0x00,"01_0_001")
    testAddR(0x84,"H",0x00,0xF0,0xF0,"10_0_000")
    testAddR(0x87,"A",0xF0,0xF0,0xE0,"10_0_001")
