...
class OpRotateShiftTest extends AnyFunSuite{
  ...
  test("run RL r / RLA") {
    ...
    TestUtils.testRegOrAddrWithFlags(List(("F",0xFF),("A",0x01)),List((0x0000,0xCB),(0x0001,0x17)),"A",0x0000,0x03,"11_0_100",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x00),("B",0x80)),List((0x0000,0xCB),(0x0001,0x10)),"B",0x0000,0x00,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x00),("C",0x81)),List((0x0000,0xCB),(0x0001,0x11)),"C",0x0000,0x02,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x00),("D",0x81)),List((0x0000,0xCB),(0x0001,0x12)),"D",0x0000,0x02,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x00),("E",0x81)),List((0x0000,0xCB),(0x0001,0x13)),"E",0x0000,0x02,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x01),("H",0x81)),List((0x0000,0xCB),(0x0001,0x14)),"H",0x0000,0x03,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x01),("L",0x81)),List((0x0000,0xCB),(0x0001,0x15)),"L",0x0000,0x03,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x00),("HL",0x0101)),List((0x0000,0xCB),(0x0001,0x06),(0x0101,0x81)),
      "",0x0101,0x03,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List(("F",0x00),("IX",0x0201)),List((0x0000,0xDD),(0x0001,0xCB),(0x0002,0x01),(0x0003,0x06),(0x0202,0x81)),
      "",0x0202,0x03,"00_0_001",4)
