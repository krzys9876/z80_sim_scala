...
class OpJumpCallReturnTest extends AnyFunSuite {
  ...
  test("run JP nn/cc,nn") {
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xC3),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0xFF)),List((0,0xC3),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"11_1_111",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xDA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xD2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x01)),List((0,0xDA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_001",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x01)),List((0,0xD2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_001",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xCA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xC2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x40)),List((0,0xCA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"01_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x40)),List((0,0xC2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"01_0_000",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xEA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xE2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x04)),List((0,0xEA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_100",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x04)),List((0,0xE2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_100",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xFA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",3)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0xF2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x80)),List((0,0xFA),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"10_0_000",0x1020)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x80)),List((0,0xF2),(1,0x20),(2,0x10)),Regs.NONE,OpCode.ANY,OpCode.ANY,"10_0_000",3)
  }

  test("run JP (HL/IX/IY") {
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.HL,0x1234)),List((0,0xE9)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1234)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0xFF),(Regs.HL,0x1234)),List((0,0xE9)),Regs.NONE,OpCode.ANY,OpCode.ANY,"11_1_111",0x1234)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.IX,0x1234)),List((0,0xDD),(1,0xE9)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1234)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0xFF),(Regs.IX,0x1234)),List((0,0xDD),(1,0xE9)),Regs.NONE,OpCode.ANY,OpCode.ANY,"11_1_111",0x1234)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.IY,0x1234)),List((0,0xFD),(1,0xE9)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1234)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0xFF),(Regs.IY,0x1234)),List((0,0xFD),(1,0xE9)),Regs.NONE,OpCode.ANY,OpCode.ANY,"11_1_111",0x1234)
  }

  test("run JR f,e") {
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0x18),(1,0x03)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",5)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0xFF)),List((0,0x18),(1,0x03)),Regs.NONE,OpCode.ANY,OpCode.ANY,"11_1_111",5)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0x38),(1,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",2)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0x30),(1,0x80)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0xFF82)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0x30),(1,0x7F)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x0081)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00)),List((0,0x30),(1,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0xFFFF)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x01)),List((0,0x38),(1,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_001",0xFFFF)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x01)),List((0,0x30),(1,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_001",2)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.PC,0x1000)),List((0x1000,0x28),(0x1001,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1002)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.PC,0x1000)),List((0x1000,0x20),(0x1001,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x0FFF)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.PC,0x1000)),List((0x1000,0x20),(0x1001,0x80)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x0F82)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.PC,0x1000)),List((0x1000,0x20),(0x1001,0x00)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1002)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.PC,0x1000)),List((0x1000,0x20),(0x1001,0x01)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1003)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x00),(Regs.PC,0x1000)),List((0x1000,0x20),(0x1001,0x7F)),Regs.NONE,OpCode.ANY,OpCode.ANY,"00_0_000",0x1081)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x40),(Regs.PC,0x1000)),List((0x1000,0x28),(0x1001,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"01_0_000",0x0FFF)
    TestUtils.testRegOrAddrWithFlags(List((Regs.F,0x40),(Regs.PC,0x1000)),List((0x1000,0x20),(0x1001,0xFD)),Regs.NONE,OpCode.ANY,OpCode.ANY,"01_0_000",0x1002)
  }
  ...
  test("run CALL nn/cc,nn") {
    ...
    TestUtils.testRegOrAddrWithFlags(List((Regs.F, 0x00), (Regs.SP, 0x1000), (Regs.PC, 0x0102)), List((0x0102, 0xDC), (0x0103, 0x20), (0x0104, 0x10)),
      Regs.SP, OpCode.ANY, 0x1000, "00_0_000", 0x0105)
    ...
    TestUtils.testRegOrAddrWithFlags(List((Regs.F, 0x01), (Regs.SP, 0x1000), (Regs.PC, 0x0102)), List((0x0102, 0xD4), (0x0103, 0x20), (0x0104, 0x10)),
      Regs.SP, OpCode.ANY, 0x1000, "00_0_001", 0x0105)
    ...
    TestUtils.testRegOrAddrWithFlags(List((Regs.F, 0x40), (Regs.SP, 0x1000), (Regs.PC, 0x0102)), List((0x0102, 0xC4), (0x0103, 0x20), (0x0104, 0x10)),
      Regs.SP, OpCode.ANY, 0x1000, "01_0_000", 0x0105)
    ...
    TestUtils.testRegOrAddrWithFlags(List((Regs.F, 0x04), (Regs.SP, 0x1000), (Regs.PC, 0x0102)), List((0x0102, 0xE4), (0x0103, 0x20), (0x0104, 0x10)),
      Regs.SP, OpCode.ANY, 0x1000, "00_0_100", 0x0105)
