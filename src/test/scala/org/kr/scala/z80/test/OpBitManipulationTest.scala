...
class OpBitManipulationTest extends AnyFunSuite {
  ...
  test ("run RES b, r/(HL)/(IX/IY+d)") {
    ...
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("IX", 0x2010)), List((0x0000,0xDD),(0x0001,0xC8),(0x0002,0x01),(0x0003,0xBE),(0x2011,0xFF)),
      "", 0x2011, 0x7F, "00_0_000",4)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0xFF), ("IY", 0x2012)), List((0x0000,0xFD),(0x0001,0xC8),(0x0002,0xFE),(0x0003,0xBE),(0x2010,0xFF)),
      "", 0x2010, 0x7F, "11_1_111",4)
