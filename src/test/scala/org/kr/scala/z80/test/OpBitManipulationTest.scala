...
class OpBitManipulationTest extends AnyFunSuite {
  ...
  test ("run RES b, r/(HL)/(IX/IY+d)") {
    ...
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("IX", 0x2010)), List((0x0000,0xDD),(0x0001,0xC8),(0x0002,0x01),(0x0003,0xB6),(0x2011,0xFF)),
      "", 0x2011, 0xBF, "00_0_000",4)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0xFF), ("IY", 0x2012)), List((0x0000,0xFD),(0x0001,0xC8),(0x0002,0xFE),(0x0003,0xAE),(0x2010,0xFF)),
      "", 0x2010, 0xDF, "11_1_111",4)
  }

  test ("run SET b, r/(HL)/(IX/IY+d)") {
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("A", 0xFE)), List((0x0000, 0xC8),(0x0001, 0xC7)), "A", OpCode.ANY, 0xFF, "00_0_000",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("B", 0x10)), List((0x0000, 0xC8),(0x0001, 0xC8)), "B", OpCode.ANY, 0x12, "00_0_000",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0xFF), ("C", 0x00)), List((0x0000, 0xC8),(0x0001, 0xD1)), "C", OpCode.ANY, 0x04, "11_1_111",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("D", 0xF0)), List((0x0000, 0xC8),(0x0001, 0xDA)), "D", OpCode.ANY, 0xF8, "00_0_000",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("E", 0x0F)), List((0x0000, 0xC8),(0x0001, 0xE3)), "E", OpCode.ANY, 0x1F, "00_0_000",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0xDF), ("H", 0xFF)), List((0x0000, 0xC8),(0x0001, 0xEC)), "H", OpCode.ANY, 0xFF, "11_1_111",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0xFF), ("L", 0xBF)), List((0x0000, 0xC8),(0x0001, 0xF5)), "L", OpCode.ANY, 0xFF, "11_1_111",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("HL", 0x1020)), List((0x0000, 0xC8),(0x0001, 0xFE),(0x1020, 0x7F)),
      "", 0x1020, 0xFF, "00_0_000",2)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0x00), ("IX", 0x2010)), List((0x0000,0xDD),(0x0001,0xC8),(0x0002,0x01),(0x0003,0xF6),(0x2011,0xBF)),
      "", 0x2011, 0xFF, "00_0_000",4)
    TestUtils.testRegOrAddrWithFlags(List(("F", 0xFF), ("IY", 0x2012)), List((0x0000,0xFD),(0x0001,0xC8),(0x0002,0xFE),(0x0003,0xEE),(0x2010,0xDF)),
