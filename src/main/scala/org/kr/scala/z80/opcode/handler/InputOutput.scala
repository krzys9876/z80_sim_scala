...
import org.kr.scala.z80.system.{Debugger, DummyChange, InputRefreshChange, OutputChange, PortID, Regs, SystemChange, Z80System}
...
object InputOutput extends OpCodeHandler {
  override def handle(code: OpCode)(implicit system: Z80System, debugger:Debugger): (List[SystemChange], Int, Int) = {
    ...
    val actualPort = system.portMapping(PortID(port,upperPort))
