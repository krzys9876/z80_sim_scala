...
object Load8Bit extends LoadSpec {
  ...
  //main registers (A-L)
    OpCode.opCodeGenReg(OpCode(0x40),1,0)++
    OpCode.opCodeGenReg(OpCode(0x48),1,0)++
    OpCode.opCodeGenReg(OpCode(0x50),1,0)++
    OpCode.opCodeGenReg(OpCode(0x58),1,0)++
    OpCode.opCodeGenReg(OpCode(0x60),1,0)++
    OpCode.opCodeGenReg(OpCode(0x68),1,0)++
    OpCode.opCodeGenReg(OpCode(0x70),1,0)++
    OpCode.opCodeGenReg(OpCode(0x78),1,0)++
    OpCode.opCodeGenReg(OpCode(0xDD,0x70),2,0)++
    OpCode.opCodeGenReg(OpCode(0xFD,0x70),2,0)
  ...
  //main registers (A-L)
    OpCode.opCodeGenReg(OpCode(0x47),1,3)++
    OpCode.opCodeGenReg(OpCode(0x40),1,3)++
    OpCode.opCodeGenReg(OpCode(0x41),1,3)++
    OpCode.opCodeGenReg(OpCode(0x42),1,3)++
    OpCode.opCodeGenReg(OpCode(0x43),1,3)++
    OpCode.opCodeGenReg(OpCode(0x44),1,3)++
    OpCode.opCodeGenReg(OpCode(0x45),1,3)
  ...
  val instructionSizeListMap: Map[List[OpCode], Int] = Map(
    List(OpCode(0x02), OpCode(0x12),
      ...
      OpCode.opCodeGen(OpCode(0x40),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x48),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x50),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x58),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x60),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x68),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x70),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0x78),1,0) -> 1,
      OpCode.opCodeGen(OpCode(0xDD,0x70),2,0) ->3,
      OpCode.opCodeGen(OpCode(0xFD,0x70),2,0) ->3,
