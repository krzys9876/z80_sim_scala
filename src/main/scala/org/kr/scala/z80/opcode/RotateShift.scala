...
object RotateShift extends OperationSpec {
  ...
  val operationListMap: Map[List[OpCode],AritheticOpLocationBase] = Map(
    List(OpCode(0xCB,0x07),OpCode(0xCB,0x00),OpCode(0xCB,0x01),OpCode(0xCB,0x02),OpCode(0xCB,0x03),
      ...
      OpCode(0xFD,0xCB,0x06),OpCode(0x07)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Rcl),
    List(OpCode(0xCB,0x0F),OpCode(0xCB,0x08),OpCode(0xCB,0x09),OpCode(0xCB,0x0A),OpCode(0xCB,0x0B),
      ...
      OpCode(0xFD,0xCB,0x0E),OpCode(0x0F)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Rrc),
    List(OpCode(0xCB,0x17),OpCode(0xCB,0x10),OpCode(0xCB,0x11),OpCode(0xCB,0x12),OpCode(0xCB,0x13),
      ...
      OpCode(0xFD,0xCB,0x16),OpCode(0x17)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Rl),
    List(OpCode(0xCB,0x1F),OpCode(0xCB,0x18),OpCode(0xCB,0x19),OpCode(0xCB,0x1A),OpCode(0xCB,0x1B),
      ...
      OpCode(0xFD,0xCB,0x1E),OpCode(0x1F)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Rr),
    List(OpCode(0xCB,0x27),OpCode(0xCB,0x20),OpCode(0xCB,0x21),OpCode(0xCB,0x22),OpCode(0xCB,0x23),
      ...
      OpCode(0xFD,0xCB,0x26)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Sla),
    List(OpCode(0xCB,0x2F),OpCode(0xCB,0x28),OpCode(0xCB,0x29),OpCode(0xCB,0x2A),OpCode(0xCB,0x2B),
      ...
      OpCode(0xFD,0xCB,0x2E)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Sra),
    List(OpCode(0xCB,0x3F),OpCode(0xCB,0x38),OpCode(0xCB,0x39),OpCode(0xCB,0x3A),OpCode(0xCB,0x3B),
      ...
      OpCode(0xFD,0xCB,0x3E)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Srl),
    List(OpCode(0xED,0x6F)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Rld),
    List(OpCode(0xED,0x67)) -> new ArithmeticOpVariableLocation(ArithmeticOpType.Rrd)
  )
