...
object Arithmetic8Bit extends OperationSpec {
  ...
  val instructionSizeListMap: Map[List[OpCode], Int] = Map(
    List(OpCode(0x87),OpCode(0x80),OpCode(0x81),OpCode(0x82),OpCode(0x83),OpCode(0x84),OpCode(0x85),OpCode(0x86),
      ...
      OpCode(0xA5),OpCode(0xA6),OpCode(0xAF),OpCode(0xA8),OpCode(0xA9),OpCode(0xAA),OpCode(0xAB),OpCode(0xAC),
      OpCode(0xAD),OpCode(0xAE),OpCode(0xB7),OpCode(0xB0),OpCode(0xB1),OpCode(0xB2),OpCode(0xB3),OpCode(0xB4),
      OpCode(0xB5)) -> 1,
    ...
    List(OpCode(0xDD, 0x86),OpCode(0xDD, 0x8E),OpCode(0xDD, 0x96),OpCode(0xDD, 0x9E),OpCode(0xDD, 0xA6),
      ...
      OpCode(0xDD, 0x9E),OpCode(0xFD, 0x9E),OpCode(0xDD, 0xA6),OpCode(0xFD, 0xA6),
      OpCode(0xDD, 0xAE),OpCode(0xFD, 0xAE)) -> 3
  )
