...
object Load16Bit extends LoadSpec {
  ...
  val sourceLocListMap: Map[List[OpCode], LoadLocation] = Map(
    //registers
    List(OpCode(0xF5, OpCode.ANY)) -> LoadLocation.register("AF"),
    List(OpCode(0xED, 0x43), OpCode(0xC5, OpCode.ANY)) -> LoadLocation.register("BC"),
    List(OpCode(0xED, 0x53), OpCode(0xD5, OpCode.ANY)) -> LoadLocation.register("DE"),
    List(OpCode(0xF9, OpCode.ANY), OpCode(0x22, OpCode.ANY), OpCode(0xE5, OpCode.ANY)) -> LoadLocation.register("HL"),
  ...
  val destLocListMap: Map[List[OpCode], LoadLocation] = Map(
    ...
    // indirect register
    List(OpCode(0xF5, OpCode.ANY), OpCode(0xC5, OpCode.ANY), OpCode(0xD5, OpCode.ANY), OpCode(0xE5, OpCode.ANY),
  ...
  val instructionSizeListMap: Map[List[OpCode], Int] = Map(
    List(OpCode(0xF9, OpCode.ANY), OpCode(0xF1, OpCode.ANY), OpCode(0xC1, OpCode.ANY),
      ...
      OpCode(0xF5, OpCode.ANY), OpCode(0xC5, OpCode.ANY), OpCode(0xD5, OpCode.ANY), OpCode(0xE5, OpCode.ANY)) -> 1,
