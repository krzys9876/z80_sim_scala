...
rem java.exe -XX:+UseSerialGC -jar target\scala-2.13\z80_sim-assembly-0.0.13.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic.txt" --steps-m 1.4 --memory-type fast --register-type fast
 ...
 java.exe -XX:+UseSerialGC -jar target\scala-2.13\z80_sim-assembly-0.0.13.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic2.txt" --steps-m 14 --memory-type fast --register-type fast
 java.exe -XX:+UseSerialGC -jar target\scala-2.13\z80_sim-assembly-0.0.13.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic2.txt" --steps-m 14 --memory-type fast --register-type slow
 java.exe -XX:+UseSerialGC -jar target\scala-2.13\z80_sim-assembly-0.0.13.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic2.txt" --steps-m 14 --memory-type slow --register-type fast
 java.exe -XX:+UseSerialGC -jar target\scala-2.13\z80_sim-assembly-0.0.13.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic2.txt" --steps-m 14 --memory-type slow --register-type slow
