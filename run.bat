...
java.exe -XX:+UseSerialGC -jar target\scala-2.13\z80_sim-assembly-0.5.jar --mode batch --hex-file input-files\basicall_KR_simpleIO.hex --basic-file input-files\tictactoe10.txt --steps-m 3600
