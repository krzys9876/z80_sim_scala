...
java.exe -jar target\scala-2.13\z80_sim-assembly-0.1.1.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic3.txt" --steps-m 50 --memory-type fast --register-type fast
java.exe -jar target\scala-2.13\z80_sim-assembly-0.1.1.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic3.txt" --steps-m 50 --memory-type fast --register-type slow
java.exe -jar target\scala-2.13\z80_sim-assembly-0.1.1.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic3.txt" --steps-m 50 --memory-type slow --register-type fast
java.exe -jar target\scala-2.13\z80_sim-assembly-0.1.1.jar --mode batch --hex-file "input-files\basicall_KR_simpleIO.hex" --basic-file "input-files\arithmetic3.txt" --steps-m 50 --memory-type slow --register-type slow
